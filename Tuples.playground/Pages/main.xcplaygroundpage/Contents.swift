...
var person: (String,Int) = ("Steve", 30)
...
var someone: (name: String, age: Int) = (name: "Julián", age: 24)
...
let human: (name: String, age: Int) = (name: "Rain", age: 20)
 ...
 */
// No, because it human is a constant, therefore human.age is also a constant.
